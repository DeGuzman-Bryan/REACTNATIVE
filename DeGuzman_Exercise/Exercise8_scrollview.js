      ...
      <ScrollView>
        <View>
          <Text style={styles.justifiedText}>
            ...
            Integer in mauris eu nibh euismod gravida. Duis ac tellus et risus vulputate vehicula. Donec lobortis risus a elit euismod, vel pretium nisl ornare. Integer euismod, urna eu tincidunt congue, elit eros gravida nisl, id euismod ligula nulla et ligula. {'\n\n'}
            {/* Adds space between sections */}
...
const styles = StyleSheet.create({
  ...
  circleBullet: {
    ...
    borderWidth: 1,
    borderColor: 'black',
    paddingRight: 10, // Space between the bullet and text
    paddingTop: 3,
    paddingBottom: 3,
    marginRight: 10,
  },
